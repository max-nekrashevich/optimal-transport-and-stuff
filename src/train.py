...
def _train(source, target, mover, critic, cost_func, *,
          n_iter, n_samples,
          n_iter_mover=10, n_iter_critic=1,
          l=.05,
          optimizer=o.Adam,
...
def train(source, target, mover, critic, cost, *,
          n_iter, n_samples,
          n_iter_mover=10, n_iter_critic=1, n_iter_cost=0,
          l=.05,
          optimizer=o.Adam,
          optimizer_params=dict(lr=5e-5),
          logger=None,
